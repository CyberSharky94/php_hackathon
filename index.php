    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <center><img style="width:200px;" src="dist/img/Experian_logo.png" class="img-circle" alt="User Image"></center>
        </div>
      </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p><h4>Customer Data</h4></p>
            </div>
            <div class="icon">
              <i class="fa fa-server"></i>
            </div>
            <a href="dataprocess.php?load=true" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
 ...
 <div class="modal modal-success fade" id="modal-success">
          <div class="modal-dialog">
            <div class="modal-content">
             <form class="form-horizontal" action="csvupload.php" method="POST" enctype="multipart/form-data">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Upload Loan CSV File</h4>
              </div>
